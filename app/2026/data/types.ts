import { Region as Regional2025 } from "@/app/2025/data/types";
...
export interface RegionalBase {
  contestDate: `2025-${string}-${string}`;
  site: string;
  region: string;
  url?: string;
  score: number;
...
export interface TeamInTeamListLikeTeamIdNullable {
  teamId: number | null;
  name: string;
  institution: string;
  problemsSolved?: number;
...
export type Regional = RegionalBase &
  (
    | {
        ...
        regionalTeams: TeamInTeamListLikeTeamIdNullable[];
      }
    | {
